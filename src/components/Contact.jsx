...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "07cae2a6-080c-447f-983a-e890f8bfab0e");
    ...
    return (
        <motion.div
            ...
            viewport={{ once: true }}
            className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden font-outfit' id='Contact'>
            ...
            <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
                ...
                <div className='my-6 text-left'>
                    Message
                    <textarea className='w-full border border-gray-300 rounded py-3 px-4 mt-4 h-48 resize-none' name="Message" placeholder='Message' required></textarea>
                </div>
